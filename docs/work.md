...
│     │  │  ├─ default_prom.yaml
│     │  │  └─ default_redis.yaml
│     │  ├📁 horizon_client_settings
│     │  │  ├─ dev_client.yaml
│     │  │  ├─ prod_client.yaml
│     │  │  └─ stage_client.yaml
│     │  ├─ horizon_wrapper_config_test.yaml
│     │  ├📁 logger
│     │  │  └─ logger.yaml
│     │  ├─ multi_wrapper_config.yaml
│     │  ├📁 plannet_client_settings
│     │  │  ├─ dev_client.yaml
│     │  │  ├─ prod_client.yaml
│     │  │  └─ stage_client.yaml
│     │  ├─ plannet_wrapper_config_test.yaml
│     │  ├📁 prometheus_settings
│     │  │  └─ prom_client.yaml
│     │  ├📁 redis_settings
│     │  │  └─ custom_client.yaml
│     │  ├📁 sauron_client_settings
│     │  │  ├─ dev_client.yaml
│     │  │  ├─ prod_client.yaml
│     │  │  └─ stage_client.yaml
│     │  └─ sauron_wrapper_config_test.yaml
│     ├─ horizon_data_retrieve_pipeline_test.py
│     ├─ multi_data_retrieve_pipeline_test.py
│     ├─ my_module.py
│     ├─ plannet_data_retrieve_pipeline_test.py
│     ├─ sauron_data_retrieve_pipeline_test.py
│     ├📁 use_cases
│        ├─ __init__.py
│        ├─ horizon_data_retrieve_handler.py
│        ├─ multi_wrapper_retrieve_handler.py
│        ├─ plannet_data_retrieve_handler.py
│        └─ sauron_data_retrieve_handler.py
├📁 tests ---------------------------------------- # the tests directory
│  ├─ __init__.py
│  ├─ conftest.py
│  └─ test_my_module.py
├📁 tmp
│  ├📁 wrapster ---------------------------------- # Wrapster and monitoring configuration files
│     ├─ __init__.py
│     ├─ docker-compose.yaml
│     ├─ grafana
│     │  ├─ dashboards
...
Configure uv to create the different virtualenvs outside of the project:
